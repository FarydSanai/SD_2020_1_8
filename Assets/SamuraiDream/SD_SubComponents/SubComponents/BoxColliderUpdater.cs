...
namespace SamuraiGame 
{
    public class BoxColliderUpdater : SubComponent
    {
        ...
        public void UpdateBoxCollider_Size()
        {
            ...
            if (Vector3.SqrMagnitude(control.boxCollider.size - boxColliderData.TargetSize) > 0.0001f)
            {
                control.boxCollider.size = Vector3.Lerp(control.boxCollider.size, boxColliderData.TargetSize,
